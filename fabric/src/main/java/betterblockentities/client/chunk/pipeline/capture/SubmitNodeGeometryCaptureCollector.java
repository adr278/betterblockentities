...
public final class SubmitNodeGeometryCaptureCollector extends SubmitNodeStorage {
    ...
    public void reset(GeometryBaker.Sink sink) { reset(sink, false); }
    ...
    private void unsupported() { this.supported = false; }
    ...
    private static int[] tintLayersFromColor(int tintColor) { return tintColor == -1 ? null : new int[]{tintColor}; }
    ...
    @Override public <S> void submitModel(
        ...
        /*
         * Match vanilla ModelFeatureRenderer flow: animate the model from the
         * submitted render-state before reading geometry from the root part
         */
