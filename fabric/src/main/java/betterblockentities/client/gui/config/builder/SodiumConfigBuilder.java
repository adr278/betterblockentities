        ...
        generalPage.addOptionGroup(builder.createOptionGroup()
                .addOption(
                        builder.createEnumOption(Identifier.parse("bbe:misc.shademode"), EnumTypes.ShadeMode.class)
                                ...
                                .setBinding(
                                        value -> BBE.GlobalScope.CONFIG.MAIN.setOption("misc.shademode", EnumTypes.ShadeMode.map(value)),
                                        () -> EnumTypes.ShadeMode.map((int)BBE.GlobalScope.CONFIG.MAIN.getOption("misc.shademode").getValue())
                                )
