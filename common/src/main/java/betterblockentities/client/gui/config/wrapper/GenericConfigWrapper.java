...
public class GenericConfigWrapper {
    ...
    public static class MainStorage {
        private static boolean getGenericBooleanOption(String key) { return (boolean)GlobalScope.CONFIG.MAIN.getOption(key).getValue(); }
        private static int getGenericIntegerOption(String key) {return (int)GlobalScope.CONFIG.MAIN.getOption(key).getValue();}
    ...
    public static class HiddenStorage {
        private static boolean getGenericBooleanOption(String key) { return (boolean)GlobalScope.CONFIG.HIDDEN.getOption(key).getValue(); }
        private static int getGenericIntegerOption(String key) {return (int)GlobalScope.CONFIG.HIDDEN.getOption(key).getValue();}
